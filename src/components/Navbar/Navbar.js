  ...
  return (
    <header className="bg-gray-800 md:sticky top-0 z-10 back">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="font-mono title-font font-medium text-white mb-4 md:mb-0">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
          ...
          <a target="_blank" href="https://www.linkedin.com/in/daniel9805/" className="mr-5 hover:text-white">
          <img
            className="iconos"
            alt="hero"
            src="./linkedin.png"
